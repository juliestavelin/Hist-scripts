...
# THIS SCRIPT CREATES A HISTORICAL RUN FROM 1901-2014
# SOIL DECOMPOSITION METHOD CAN BE CHOOSEN
# CHANGE THIS BASED ON SITES#
declare -A sites
sites=(
...
restart_date="1901-01-01-00000" #Change to the latest datafile
...
for plotname in "${!sites[@]}"; do
surf_suffix="${sites[$plotname]}"
case_name="${plotname}_hist_2_N1850_${decomp}"
...
cd $CIMEROOT/scripts
echo $CIMEROOT/scripts
#./create_newcase --case $casedir --compset $compset --res $resolution --user-mods-dirs ~/${plotname}/user_mods --machine $machine --run-unsupported --handle-preexisting-dirs r --project $CESM_ACCOUNT
./create_newcase --case $casedir --compset $compset --res $resolution --user-mods-dirs /cluster/projects/nn2806k/stavelin/sites/${plotname}/user_mods --machine $machine --run-unsupported --handle-preexisting-dirs r --project $CESM_ACCOUNT
...
# Change surfacedata file & restartfile (fsurdat & finidat)
#cat << EOF > user_nl_clm
# 'TSOI', 'SMIN_NO3', 'SMIN_NH4', 'SOM_N_LEACHED'
#presndep.clim_1850:datafiles = '/cluster/projects/nn2806k/stavelin/ndep_streams.nc' #Need this when i have changed the nitrogen input
echo \
"fsurdat='/cluster/projects/nn2806k/stavelin/sites/${plotname}/surfdata_${plotname}_hist_2000_16pfts_${surf_suffix}.nc'
finidat='/cluster/work/users/stavelin/archive/${plotname}_hist_1_N1850_${decomp}/rest/${restart_date}/${plotname}_hist_1_N1850_${decomp}.clm2.r.${restart_date}.nc'
...
# change the user_nl file to the example file with the changes i have done in ndep_streams.nc
#cp -f $startdir/example_user_nl_datm ./user_nl_datm_streams

echo -e "\n\npresndep.hist:datafiles=/cluster/projects/nn2806k/stavelin/datafiles/ndep_streams_hist_constant.nc\n\n" >> user_nl_datm_streams
echo -e "\n\npresndep.hist:datavars=NDEP_month_NHx_1850_1860 Faxa_ndep_nhx,NDEP_month_NOy_1850_1860 Faxa_ndep_noy\n\n" >> user_nl_datm_streams
